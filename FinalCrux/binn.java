...
//		System.out.println("String to be passed in Recursive Function: "+myStr.substring(1));
 ...
 // System.out.println(drep);
       ...
       // System.out.println(encyptStr);
        int niz=encyptStr.length()/2; //size of encrypt string
    ...
    /*public static void option1(String loc) {
        
    	String plainString =dl(loc);
        String rev=reverseString(plainString);//reverse
        String encyptStr   = encrypt(rev);//encrypt the reverse string
        System.out.println(encyptStr);
        int niz=encyptStr.length()/2; //size of encrypt string
        String gt= getAlphaNumericString(niz);
        String fin=encyptStr+gt+encyptStr;//encrypt+randomstr+encrypt
        String ff=longestRepeatedSubstring(fin);//using dynamic obtain encrypt
        System.out.println(ff);
        String decryptStr1  = decrypt(ff);//decrypt it 
        System.out.println(reverseString(decryptStr1));//print the reverse of decryption
   }   
